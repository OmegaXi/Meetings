...
class MyUser(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)  # 这里的user与User是一对一的关系
...
class Detail(models.Model):
    ...
    room = models.ForeignKey(ConfeRoom, on_delete=models.CASCADE)  # 这里采用多对一的关系，一个学院有很多会议室，而一个会议室只能属于一个学院
